"""
Django settings for vtest5453raapp_2 project.
...
ROOT_URLCONF = 'vtest5453raapp_2.urls'
...
WSGI_APPLICATION = 'vtest5453raapp_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "vtest5453RAapp Support <support@vtest5453raapp-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vtest5453raapp_2 API",
    "DESCRIPTION": "API documentation for vtest5453raapp_2 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "vtest5453raapp_2.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "vtest5453raapp_2.storage_backends.AzureStaticStorage"
